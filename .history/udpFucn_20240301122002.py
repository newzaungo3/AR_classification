class UdpComms():
    def __init__(self,udpIP,portTX,portRX,enableRX=False,suppressWarnings=True):
        ...
        import socket
        self.udpIP = udpIP
        self.sendIP = '2405:9800:b670:a9c9:755c:50aa:a1c5:69d4'
        ...
        # Connect via UDP
        self.udpSock = socket.socket(socket.AF_INET6, socket.SOCK_DGRAM) # internet protocol, udp (DGRAM) socket
        ...
        #self.udpSock.setsockopt(socket.IPPROTO_IPV6, 26, 0)
    ...
    def ReceiveData(self):
        ...
        try:
            ...
            #struck at 65536 byte
            while len(image_data) < length:
                packet, _ = self.udpSock.recvfrom(8194)  # Adjust buffer size as needed
