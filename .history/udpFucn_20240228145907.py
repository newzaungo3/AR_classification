class UdpComms():
    def __init__(self,udpIPSend, udpIPReceive,portTX,portRX,enableRX=False,suppressWarnings=True):
        """
        Constructor
        ...
        import socket
        self.udpIPSend = udpIPSend
        self.udpIPReceive = udpIPReceive
        ...
        self.udpSock.bind((udpIPReceive, portRX))
        self.udpSock.settimeout(None)
    ...
    def SendData(self, strToSend):
        ...
        self.udpSock.sendto(bytes(strToSend, 'utf-8'), (self.udpIPSend, self.udpSendPort))
    ...
    def ReadUdpThreadFunc(self): # Should be called from thread
        ...
        """
        self.udpSock.bind((self.udpIPReceive, self.udpRcvPort))
